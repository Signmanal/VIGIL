...
```bash
python3 -m pyfiglet "VIGIL" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=VIGIL&font=Slant" | boxes -d stone
```
