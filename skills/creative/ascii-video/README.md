...
Built for [VIGIL Agent](https://github.com/NousResearch/vigil-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/vigil-agent/skills/creative/ascii-video`](https://github.com/NousResearch/vigil-agent/tree/main/skills/creative/ascii-video) via PR.
