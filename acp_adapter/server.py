...
class VIGILACPAgent(acp.Agent):
    ...
    async def initialize(
        ...
        **kwargs: Any,
        ...
        return InitializeResponse(
            ...
            agent_info=Implementation(name="vigil-agent", version=VIGIL_VERSION),
    ...
    async def prompt(
        ...
        **kwargs: Any,
        ...
        # not the executor's. Also set VIGIL_INTERACTIVE so approval.py
        ...
        def _run_agent() -> dict:
            ...
            previous_interactive = os.environ.get("VIGIL_INTERACTIVE")
            ...
            try:
                ...
                # Restore VIGIL_INTERACTIVE.
                if previous_interactive is None:
                    os.environ.pop("VIGIL_INTERACTIVE", None)
                else:
                    os.environ["VIGIL_INTERACTIVE"] = previous_interactive
    ...
    def _cmd_version(self, args: str, state: SessionState) -> str:
        return f"VIGIL Agent v{VIGIL_VERSION}"
