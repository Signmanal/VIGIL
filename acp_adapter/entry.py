"""CLI entry point for the vigil-agent ACP adapter.
...
def _run_check() -> None:
    ...
    from acp_adapter.server import VIGILACPAgent  # noqa: F401
...
def main(argv: list[str] | None = None) -> None:
    ...
    logger.info("Starting vigil-agent ACP adapter")
    ...
    import acp
    from .server import VIGILACPAgent
