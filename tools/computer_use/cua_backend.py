...
_CUA_DRIVER_CMD = os.environ.get("VIGIL_CUA_DRIVER_CMD", "cua-driver")
...
def _resolve_mcp_invocation(
    ...
    *,
    ...
    Surface 8 of NousResearch/vigil-agent#47072: instead of hardcoding
...
def cua_driver_binary_available() -> bool:
    """True if `cua-driver` is on $PATH or VIGIL_CUA_DRIVER_CMD resolves."""
...
def _parse_elements_from_structured(raw_elements: List[Dict[str, Any]]) -> List[UIElement]:
    """Surface 2 of NousResearch/vigil-agent#47072: read the canonical
...
class _CuaDriverSession:
    ...
    def __init__(self, bridge: _AsyncBridge) -> None:
        ...
        self._started = False
        # Surface 4 of NousResearch/vigil-agent#47072: per-tool
    ...
    async def _lifecycle_coro(self) -> None:
        ...
        try:
            ...
            params = StdioServerParameters(
                ...
                # sanitize VIGIL-managed secrets out of the child env.
...
def _extract_tool_result(mcp_result: Any) -> Dict[str, Any]:
    ...
    NousResearch/vigil-agent#47072). Each entry corresponds index-for-index
...
class CuaDriverBackend(ComputerUseBackend):
    ...
    def __init__(self) -> None:
        ...
        # Surface 6 of NousResearch/vigil-agent#47072: per-snapshot
    ...
    def capture(self, mode: str = "som", app: Optional[str] = None) -> CaptureResult:
        ...
        # Surface 3 of NousResearch/vigil-agent#47072: read the canonical
        ...
        if mode == "vision":
            ...
            # Surface 2 of NousResearch/vigil-agent#47072: prefer the
    ...
    def click(
        ...
        *,
        ...
        # NousResearch/vigil-agent#47072). cua-driver-rs gained an explicit
