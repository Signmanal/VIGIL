...
def reap_orphan_containers(
    ...
    * ``label=vigil-agent=1`` (created by this codebase)
...
def _image_uses_init_entrypoint(docker_exe: str, image: str) -> bool:
    ...
    ``vigil-agent:latest``) already provide their own PID-1 init and execute
...
class DockerEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        # s6-overlay images (e.g. vigil-agent:latest) already use /init as PID 1
