...
class BaseEnvironment(ABC):
    ...
    def __init__(self, cwd: str, timeout: int, env: dict = None):
        ...
        self._snapshot_path = f"{temp_dir}/vigil-snap-{self._session_id}.sh"
        self._cwd_file = f"{temp_dir}/vigil-cwd-{self._session_id}.txt"
    ...
    def init_session(self):
        ...
        # caused ``C:/Users/.../vigil-snap-*.sh: No such file or directory``
