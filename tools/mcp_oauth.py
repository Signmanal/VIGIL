...
This module provides the glue:
    - ``VIGILTokenStorage``: persists tokens/client-info to disk so they
...
# ---------------------------------------------------------------------------
# VIGILTokenStorage -- persistent token/client-info on disk
# ---------------------------------------------------------------------------


class VIGILTokenStorage:
...
async def _redirect_handler(authorization_url: str) -> None:
    ...
    if _oauth_port and (os.getenv("SSH_CLIENT") or os.getenv("SSH_TTY")):
        print(
            ...
            f"\n"
            f"  See: https://vigil-agent.nousresearch.com/docs/guides/oauth-over-ssh\n",
            file=sys.stderr,
        )
