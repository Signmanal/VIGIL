...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    mkdir -p $out/share/vigil-desktop $out/bin
    cp -r ${renderer}/* $out/share/vigil-desktop/
    ...
    substituteInPlace $out/share/vigil-desktop/electron/main.cjs \
      --replace-fail "process.resourcesPath" "'$out/share/vigil-desktop'"
    ...
    makeWrapper ${lib.getExe electron} $out/bin/vigil-desktop \
      --add-flags "$out/share/vigil-desktop" \
  ...
  meta = with lib; {
    description = "Native Electron desktop shell for VIGIL Agent";
    homepage = "https://github.com/NousResearch/vigil-agent";
    license = licenses.mit;
    platforms = platforms.unix;
    mainProgram = "vigil-desktop";
  };
}
