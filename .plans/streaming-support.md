# Streaming LLM Response Support for VIGIL Agent
...
```
VIGIL_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("VIGIL_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `vigil_cli/config.py` | 1 | +streaming config defaults |
