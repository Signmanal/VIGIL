...
DIRECTORY_PATH = get_vigil_home() / "channel_directory.json"
...
CHANNEL_ALIASES_PATH = get_vigil_home() / "channel_aliases.json"
...
def _build_from_sessions(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_vigil_home() / "sessions" / "sessions.json"
