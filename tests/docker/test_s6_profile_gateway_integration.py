...
The unit tests in tests/vigil_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned vigil-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/vigil")
from vigil_cli.service_manager import S6ServiceManager
