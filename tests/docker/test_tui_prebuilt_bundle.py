...
def test_vigil_tui_dir_env_is_set(built_image: str) -> None:
    ...
    assert r.stdout.strip() == "/opt/vigil/ui-tui", (
        f"VIGIL_TUI_DIR={r.stdout.strip()!r} (expected /opt/vigil/ui-tui)"
    )
...
def test_prebuilt_bundle_present_and_no_runtime_install(built_image: str) -> None:
    ...
    py = (
        ...
        "from vigil_cli.main import _tui_need_npm_install, _find_bundled_tui, _make_tui_argv\n"
        "ui = Path('/opt/vigil/ui-tui')\n"
