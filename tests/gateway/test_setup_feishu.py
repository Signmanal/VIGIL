"""Tests for _setup_feishu() in vigil_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("vigil_cli.config.save_env_value", side_effect=mock_save), \
         patch("vigil_cli.config.get_env_value", side_effect=mock_get), \
         patch("vigil_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("vigil_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("vigil_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("vigil_cli.cli_output.print_header"), \
         patch("vigil_cli.cli_output.print_info"), \
         patch("vigil_cli.cli_output.print_success"), \
         patch("vigil_cli.cli_output.print_warning"), \
         patch("vigil_cli.cli_output.print_error"), \
