...
the shared /blueprint command handler (vigil_cli/blueprint_cmd.py), and
...
class TestRenderers:
    ...
    def test_catalog_entry_has_all_surfaces(self):
        ...
        assert entry["appUrl"].startswith("vigil://")
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from vigil_cli.blueprint_cmd import handle_blueprint_command, match_blueprint
