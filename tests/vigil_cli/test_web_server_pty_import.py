"""Test the platform-branched PTY bridge import in vigil_cli.web_server.
...
def test_web_server_uses_win_pty_bridge_on_windows():
    ...
    from vigil_cli.win_pty_bridge import WinPtyBridge
    ...
    from vigil_cli.win_pty_bridge import PtyUnavailableError as WinErr
...
def test_web_server_uses_posix_pty_bridge_on_posix():
    ...
    from vigil_cli.pty_bridge import PtyBridge as PosixBridge
    from vigil_cli.pty_bridge import PtyUnavailableError as PosixErr
...
def test_pty_bridge_import_block_is_platform_branched():
    ...
    #       try:
    #           from vigil_cli.win_pty_bridge import WinPtyBridge as PtyBridge, ...
    #       except ImportError:
    #           PtyBridge = None
    #           ...
    #   else:
    ...
    assert "from vigil_cli.win_pty_bridge import" in src
    assert "from vigil_cli.pty_bridge import" in src
