"""Tests for the kanban CLI surface (vigil_cli.kanban)."""
...
from vigil_cli import kanban as kc
...
def test_run_slash_session_filter(kanban_home):
    """`vigil kanban list --session <id>` filters by the originating
...
def test_kanban_in_autocomplete_table():
    from vigil_cli.commands import COMMANDS, SUBCOMMANDS
