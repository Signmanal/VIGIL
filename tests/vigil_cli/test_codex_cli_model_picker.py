...
@pytest.fixture()
def vigil_auth_only_env(tmp_path, monkeypatch):
...
def test_normal_path_still_works(vigil_auth_only_env):
...
def test_codex_picker_uses_live_codex_catalog(vigil_auth_only_env, tmp_path, monkeypatch):
