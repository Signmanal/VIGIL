...
from vigil_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(vigil_home, memory_text="", user_text=""):
    mem_dir = vigil_home / "memories"
...
def _seed_skill(vigil_home, name, description):
    skill_dir = vigil_home / "skills" / "demo" / name
