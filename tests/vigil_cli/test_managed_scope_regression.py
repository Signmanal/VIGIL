...
def test_user_config_overrides_default(vigil_home, monkeypatch):
    from vigil_cli.config import load_config, cfg_get
...
def test_env_expansion_in_user_config(vigil_home, monkeypatch):
    from vigil_cli.config import load_config, cfg_get
...
def test_no_managed_dir_means_user_value_wins(vigil_home):
...
def test_user_env_overrides_shell(tmp_path, monkeypatch):
    ...
    load_vigil_dotenv(vigil_home=str(home))
