"""Tests for vigil_cli.security_advisories.
...
import vigil_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full vigil_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "vigil_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "vigil_cli.config.save_config",
