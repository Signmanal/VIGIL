...
class TestVIGILHomeIsolation:
    ...
    def test_failure_marker_respects_hermes_home(self):
        ...
        with patch.dict(os.environ, {"VIGIL_HOME": "/custom/hermes"}):
    ...
    def test_conftest_isolation_prevents_real_home_writes(self):
        ...
        hermes_home = os.getenv("VIGIL_HOME")
        assert hermes_home is not None, "VIGIL_HOME should be set by conftest"
