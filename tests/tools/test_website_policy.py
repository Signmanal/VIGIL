...
def test_check_website_access_uses_dynamic_vigil_home(monkeypatch, tmp_path):
    ...
    # Invalidate the module-level cache so the new VIGIL_HOME is picked up.
    # A prior test may have cached a default policy (enabled=False) under the
    # old VIGIL_HOME set by the autouse _isolate_vigil_home fixture.
