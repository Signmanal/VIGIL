...
@pytest.fixture
def vigil_home(monkeypatch, tmp_path):
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, vigil_home, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, vigil_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, vigil_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_new_file_written_as_is(self, vigil_home, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, vigil_home, tmp_path):
