...
A runner that uses VIGIL's built-in execution environments
(local, docker, modal) and outputs trajectories in the VIGIL format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses VIGIL's Docker, Modal, or Local environments for command execution
...
# ============================================================================
# Terminal Tool Definition (matches VIGIL format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using VIGIL's built-in backends.
...
class MiniSWERunner:
    """
    Agent runner that uses VIGIL's built-in execution environments
    and outputs trajectories in VIGIL format.
    """
...
Complete the user's task step by step."""
        ...
        trajectory = self._convert_to_vigil_format(messages, task, completed)
