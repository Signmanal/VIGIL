 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `vigil_cli/web_server.py`.
 */
...
/**
 * Nous Blue — the inverted "light mode" VIGIL look, ported from the
 ...
 * nousnet-web's <body> is white; vigil-agent's App root is `bg-black`,
