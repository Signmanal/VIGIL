...
const STORAGE_KEY = "vigil-dashboard-theme";
...
const FONT_STORAGE_KEY = "vigil-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `vigil_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "vigil-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-vigil-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-vigil-theme-font", "true");
