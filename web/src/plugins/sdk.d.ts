/**
 * VIGIL Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__VIGIL_PLUGIN_SDK__`` and
 * ``window.__VIGIL_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__VIGIL_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``VIGILPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@vigil/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__VIGIL_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__VIGIL_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__VIGIL_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface VIGILPluginSDK {
...
declare global {
  interface Window {
    __VIGIL_PLUGIN_SDK__?: VIGILPluginSDK;
    __VIGIL_PLUGINS__?: PluginRegistry;
  }
}
