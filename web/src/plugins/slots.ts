 ...
 * `window.__VIGIL_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the VIGIL brand in the top bar
 ...
 *  `window.__VIGIL_PLUGINS__.registerSlot(...)`.
 *
