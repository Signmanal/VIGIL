 ...
 *
 * Plugins call window.__VIGIL_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__VIGIL_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__VIGIL_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__VIGIL_PLUGIN_SDK__ = {
    ...
    // window.__VIGIL_SESSION_TOKEN__ directly.
    authedFetch,
