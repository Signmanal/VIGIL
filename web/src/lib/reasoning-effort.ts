 ...
 *
 * Values mirror vigil_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the VIGIL default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (VIGIL' default when unset). */
