...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateVIGIL: "Aggiorna VIGIL",
    updatingVIGIL: "Aggiornamento di VIGIL…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin VIGIL (parità con `hermes plugins`).",
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.vigil/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.vigil/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.vigil/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge VIGIL da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni VIGIL in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa VIGIL di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando VIGIL rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "VIGIL sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
