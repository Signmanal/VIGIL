...
export const es: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de VIGIL (equivalente a `hermes plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.vigil/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.vigil/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.vigil/skills/",
