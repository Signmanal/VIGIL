...
export const ga: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins VIGIL (paireacht le `hermes plugins`).",
    ...
    removeConfirm: "Bain an plugin seo ó ~/.vigil/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.vigil/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.vigil/skills/",
