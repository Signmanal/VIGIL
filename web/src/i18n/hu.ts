...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateVIGIL: "XCLAW frissítése",
    updatingVIGIL: "XCLAW frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "XCLAW-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `vigil plugins` paritás).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető XCLAW-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "XCLAW munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a XCLAW kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A XCLAW egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
