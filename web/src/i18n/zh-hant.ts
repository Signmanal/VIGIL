...
export const zhHant: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "探索、安裝、啟用並更新 VIGIL 外掛（對齊 `hermes plugins` CLI）。",
    ...
    removeConfirm: "從 ~/.vigil/plugins/ 移除此外掛？",
    removeHint: "僅可移除位於 ~/.vigil/plugins 下使用者安裝的外掛。",
  ...
  skills: {
    ...
    categories: "分類",
    filters: "篩選",
    noSkills: "找不到技能。技能由 ~/.vigil/skills/ 載入",
