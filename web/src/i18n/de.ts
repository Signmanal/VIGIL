...
export const de: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Dieses Plugin aus ~/.vigil/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.vigil/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.vigil/skills/ geladen",
