...
export const uk: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни VIGIL (паритет з `hermes plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.vigil/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.vigil/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.vigil/skills/",
