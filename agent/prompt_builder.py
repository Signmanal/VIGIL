...
VIGIL_AGENT_HELP_GUIDANCE = (
    ...
    "the documentation at https://vigil-agent.nousresearch.com/docs is your "
    "authoritative reference and always holds the latest, most up-to-date "
    "information. Load the `vigil-agent` skill with skill_view(name='vigil-agent') "
...
#
# The vigil-agent runtime already executes a batch of tool calls
...
# from Cline's TypeScript tool-surface guidance to vigil-agent's Python
...
def build_environment_hints() -> str:
    ...
    if _in_desktop or _in_desktop_term:
        _desktop_hint = "Runtime surface: you're running inside the VIGIL desktop GUI app."
        if _in_desktop_term:
            _desktop_hint += (
