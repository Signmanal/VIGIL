...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around VIGIL's web-provider config and
        ...
        # native search engine for xAI sessions instead of VIGIL's
        # configured web provider (Tavily/etc.), and those results bypass
        # VIGIL's tool-trace / citation plumbing (they arrive baked into the
