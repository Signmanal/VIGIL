...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - VIGIL-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all VIGIL-internal scaffolding markers (``_``-prefixed).
    ...
    def normalize_response(self, response: Any, **kwargs) -> NormalizedResponse:
        ...
        # Bedrock (e.g. VIGIL Portal) surface a Claude refusal this way — or via
