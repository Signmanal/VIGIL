...
upstream prefix cache warm.  See ``vigil-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Pointer to the vigil-agent skill + docs for user questions about VIGIL itself.
    ...
    if active_profile == "default":
        stable_parts.append(
            ...
            "under ~/.vigil/profiles/<name>/. Each profile has its own "
        ...
        stable_parts.append(
            ...
            f"and writes ~/.vigil/profiles/{active_profile}/. The default "
            f"profile's data lives at ~/.vigil/skills/, ~/.vigil/plugins/, "
            f"~/.vigil/cron/, ~/.vigil/memories/ — those belong to a "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — VIGIL never rebuilds or reinjects parts of it
