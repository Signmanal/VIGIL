...
from vigil_cli.timeouts import get_provider_request_timeout
...
def init_agent(
    ...
    Args:
        ...
        skip_context_files (bool): If True, skip auto-injection of project context files
            (SOUL.md, .vigil.md, AGENTS.md, CLAUDE.md, .cursorrules) from the cwd / VIGIL_HOME
    ...
    agent._cache_ttl = "5m"
    try:
        from vigil_cli.config import load_config as _load_pc_cfg
    ...
    from vigil_logging import setup_logging, setup_verbose_logging
    setup_logging(vigil_home=_ra()._vigil_home)
    ...
    if agent.verbose_logging:
        ...
        # on the fact that vigil_logging.setup_logging() does not
        ...
        # handler level inside vigil_logging.py, not here.
        pass
    ...
    if agent.api_mode == "anthropic_messages":
        ...
        try:
            from vigil_cli.config import load_config as _load_br_cfg
    ...
    agent.logs_dir = vigil_home / "sessions"
    ...
    try:
        from vigil_cli.config import load_config as _load_sess_cfg
    ...
    try:
        from vigil_cli.config import load_config as _load_agent_config
            ...
            if _mem_provider_name and _mem_provider_name.strip():
                ...
                if agent._memory_manager.providers:
                    ...
                    try:
                        ...
                        _init_kwargs["agent_workspace"] = "vigil"
                    except Exception:
                        pass
    ...
    if _engine_name != "compressor":
        ...
        if _selected_engine is None:
            _candidate = None
            try:
                from vigil_cli.plugins import get_plugin_context_engine
