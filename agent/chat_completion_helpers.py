...
from vigil_cli.timeouts import get_provider_request_timeout, get_provider_stale_timeout
from vigil_constants import PARTIAL_STREAM_STUB_ID, FINISH_REASON_LENGTH
    ...
    if _ttfb_timeout <= 0:
        ...
        if (
            ...
            logger.info(
                ...
                "Set VIGIL_CODEX_TTFB_STRICT=1 to force early reconnects.",
...
def build_api_kwargs(agent, api_messages: list) -> dict:
    ...
    if _is_qwen:
        _qwen_meta = {
            "sessionId": agent.session_id or "vigil",
...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        if not fb_api_key_hint:
            ...
            # _normalize_custom_provider_entry in vigil_cli/config.py).
...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    ...
    try:
        ...
        for msg in messages:
            ...
            # and every VIGIL-internal underscore-prefixed scaffolding key.
...
def interruptible_streaming_api_call(agent, api_kwargs: dict, *, on_first_delta=None):
    ...
    # the user explicitly set VIGIL_STREAM_STALE_TIMEOUT.
