...
def _state_file() -> Path:
    return get_vigil_home() / "skills" / ".curator_state"
...
CURATOR_REVIEW_PROMPT = (
    ...
    "to find: vigil-config-*, vigil-dashboard-*, gateway-*, codex-*, "
...
def _reports_root() -> Path:
    ...
    ``ensure_vigil_home()`` pre-creates this dir on every CLI launch and
    ...
    that bypasses both.
    """
    root = get_vigil_home() / "logs" / "curator"
    try:
