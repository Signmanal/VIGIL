...
(``vigil``, ``vigil-agent``, ``vigil-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import vigil_bootstrap``
# (or ``from vigil_bootstrap import apply_windows_utf8_bootstrap``) at
