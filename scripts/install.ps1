...
$RepoUrlSsh = "git@github.com:Signmanal/VIGIL.git"
$RepoUrlHttps = "https://github.com/Signmanal/VIGIL.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/Signmanal/VIGIL/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/Signmanal/VIGIL/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/Signmanal/VIGIL/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
