...
DEFAULT_DATASETS = [
    ...
    "NousResearch/vigil-agent-megascience-sft1",
    "NousResearch/VIGIL-Thinking-GLM-4.7-SFT2",
    "NousResearch/VIGIL-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-vigil-agent"
]
