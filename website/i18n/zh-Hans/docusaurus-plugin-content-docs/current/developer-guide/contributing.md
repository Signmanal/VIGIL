...
sidebar_position: 4
title: "贡献指南"
description: "如何为 VIGIL Agent 做贡献 — 开发环境配置、代码风格、PR 流程"
---

# 贡献指南

感谢您为 VIGIL Agent 做贡献！本指南涵盖开发环境配置、代码库结构说明以及 PR 合并流程。
...
提交贡献即表示您同意您的贡献将以 [MIT 许可证](https://github.com/NousResearch/vigil-agent/blob/main/LICENSE) 授权。