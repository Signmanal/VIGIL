...
| 优先级 | 文件 | 搜索范围 | 说明 |
|--------|------|----------|------|
| 1 | `.vigil.md`、`VIGIL.md` | 从 CWD 向上至 git 根目录 | VIGIL 原生项目配置 |
...
1. `.vigil.md` / `VIGIL.md`（向上遍历至 git 根目录）
...
- 项目上下文文件，如 `.vigil.md`、`VIGIL.md`、`AGENTS.md`、`CLAUDE.md` 或 `.cursorrules` — 注入仓库特定的工作规则。
