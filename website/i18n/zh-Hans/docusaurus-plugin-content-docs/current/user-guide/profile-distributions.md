...
- **你只想在自己的机器上备份一个 profile。** 使用 [`vigil profile export` / `import`](../reference/profile-commands.md#vigil-profile-export)——那正是这两个命令的用途。
...
- [`vigil profile export` / `import`](../reference/profile-commands.md#vigil-profile-export) — 本地备份 / 恢复（非分发）
- [在 VIGIL 中使用 SOUL](../guides/use-soul-with-vigil.md) — 编写个性
