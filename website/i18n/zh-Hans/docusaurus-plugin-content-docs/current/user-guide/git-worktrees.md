...
VIGIL Agent 常用于大型、长期维护的仓库。当你需要：
...
- 新目录：`../repo-feature`
- 新分支：`feature/vigil-experiment`，已在该目录中检出
...
- 在各自的分支上工作（`feature/vigil-a` 与 `feature/vigil-b`）。
...
- **以实验内容命名分支**
  - 例如：`feature/vigil-checkpoints-docs`、`feature/vigil-refactor-tests`。
- **频繁提交**
