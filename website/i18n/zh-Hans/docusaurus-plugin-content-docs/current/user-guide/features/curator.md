...
跟踪 [issue #7816](https://github.com/NousResearch/vigil-agent/issues/7816)。
...
- `~/.vigil/skills/.hub/lock.json`（通过 `hermes skills install` 安装的技能）。
...
- [Issue #7816](https://github.com/NousResearch/vigil-agent/issues/7816)——原始提案与设计讨论