...
description: "Official optional skills shipped with vigil-agent — install via hermes skills install official/<category>/<skill>"
---
...
| [**hermes-s6-container-supervision**](/docs/user-guide/skills/optional/devops/devops-hermes-s6-container-supervision) | Modify, debug, or extend the s6-overlay supervision tree inside the VIGIL Agent Docker image — adding new services, debugging profile gateways, understanding the Architecture B main-program pattern. |
