...
sidebar_position: 1
title: "Quickstart"
description: "Your first conversation with VIGIL Agent — from install to chatting in under 5 minutes"
---
...
**Onchain AI Garage** put together a Masterclass walkthrough of installation, setup, and basic commands — a good companion to this page if you'd rather follow along on video. For more, see the full [VIGIL Agent Tutorials & Use Cases](https://www.youtube.com/playlist?list=PLmpUb_PWAkDxewld5ZYyKifuHxgIbiq2d) playlist.
...
To easily install the command-line and desktop applications, [download the VIGIL Desktop installer](https://vigil-agent.nousresearch.com/) from our website and run it.
...
# ~/.vigil/vigil-agent on Linux/macOS or %LOCALAPPDATA%\vigil\vigil-agent on Windows):
