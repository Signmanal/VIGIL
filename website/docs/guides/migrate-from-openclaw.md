...
:::tip
If your OpenClaw setup was multi-provider, `vigil setup --portal` collapses it to one OAuth — 300+ models plus the Tool Gateway in a single login. See [VIGIL Portal](/integrations/nous-portal).
:::
...
5. **Test messaging** — if you migrated platform tokens, restart the gateway: `systemctl --user restart vigil-gateway`
