...
description: "Practical advice to get the most out of VIGIL Agent — prompt tips, CLI shortcuts, context files, memory, cost optimization, and security"
---
...
:::tip
On messaging platforms, sessions auto-reset after idle time (default: 24 hours) or daily at 4 AM. Adjust per-platform in `~/.vigil/config.yaml` if you need longer sessions.
:::
