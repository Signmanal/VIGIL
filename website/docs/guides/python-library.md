...
Install VIGIL directly from the repository:

```bash
pip install git+https://github.com/NousResearch/vigil-agent.git
```

Or with [uv](https://docs.astral.sh/uv/):

```bash
uv pip install git+https://github.com/NousResearch/vigil-agent.git
```

You can also pin it in your `requirements.txt`:

```text
vigil-agent @ git+https://github.com/NousResearch/vigil-agent.git
```
