...
description: "A practical guide to connecting MCP servers to VIGIL Agent, filtering their tools, and using them safely in real workflows"
---

# Use MCP with VIGIL

This guide shows how to actually use MCP with VIGIL Agent in day-to-day workflows.
...
2. VIGIL-added utility wrappers
- filtered with:
  - `tools.resources`
  - `tools.prompts`
