---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in VIGIL Agent"
description: "Try NVIDIA Nemotron 3 Ultra on VIGIL Portal — free June 4–18 — with day 0 support in VIGIL Agent"
---

# Run Nemotron 3 Ultra free in VIGIL Agent

Nous Research has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [VIGIL Portal](https://portal.nousresearch.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your VIGIL Agent today.
...
[Download the VIGIL Desktop installer](https://vigil-agent.nousresearch.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect VIGIL Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **VIGIL Portal** (marked **Recommended**). Your browser opens — create a [VIGIL Portal](https://portal.nousresearch.com) account (or sign in), choose the **Free** plan, and authorize VIGIL. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://vigil-agent.nousresearch.com/install.sh), inspect it, then run it.
...
### 3. Create a VIGIL Portal account

In the browser, create a [VIGIL Portal](https://portal.nousresearch.com) account (or sign in) and choose the **Free** plan.

### 4. Connect your account

When prompted to connect your account to VIGIL Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the VIGIL Portal connection and that you're on the **Free** plan. In the CLI, `vigil portal info` confirms you're logged in and routing through Nous.
...
- **[Run VIGIL Agent with VIGIL Portal](/guides/run-vigil-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
- **[VIGIL Portal integration](/integrations/nous-portal)** — What's in the subscription
