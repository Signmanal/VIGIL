...
description: "Three protocols for driving vigil-agent from external programs: ACP, the TUI gateway JSON-RPC, and the OpenAI-compatible HTTP API"
---
...
Every command in the Pi-mono RPC spec ([issue #360](https://github.com/NousResearch/vigil-agent/issues/360)) has a TUI-gateway equivalent:
...
GET  /v1/models                  Lists vigil-agent
