...
2. **context** — caller-supplied `system_message` plus project context files (`.vigil.md` / `AGENTS.md` / `CLAUDE.md` / `.cursorrules`)
...
- **YAML frontmatter stripped** — `.vigil.md` frontmatter is removed (reserved for future config overrides)
