...
See [Building a VIGIL Plugin](/guides/build-a-hermes-plugin#distribute-via-pip) for the full entry-points setup.
...
- [Building a VIGIL Plugin](/guides/build-a-hermes-plugin) — general plugin authoring
