...
2. **Plugin tools** — `vigil_cli.plugins.discover_plugins()` loads user/project/pip plugins that may register additional tools.
...
- platform presets (`vigil-cli`, `vigil-telegram`, etc.)
- dynamic MCP toolsets
- curated special-purpose sets like `vigil-acp`
