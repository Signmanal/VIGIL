...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to VIGIL Agent — schemas, handlers, registration, and toolsets"
---
...
- [Build a VIGIL Plugin](/guides/build-a-vigil-plugin)
...
If your tool requires an API key, add it to `vigil_cli/config.py`:
...
- [ ] Optional: API key added to `OPTIONAL_ENV_VARS` in `vigil_cli/config.py`
