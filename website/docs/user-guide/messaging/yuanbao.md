...
sidebar_position: 16
title: "Yuanbao"
description: "Connect VIGIL Agent to the Yuanbao enterprise messaging platform via WebSocket gateway"
---
...
4. Consider enabling verbose logging: `VIGIL_LOG_LEVEL=debug`
