...
- A topic name (any unique string — `vigil-myname-2026` works fine)
...
```
NTFY_TOPIC=vigil-myname-2026
NTFY_ALLOWED_USERS=vigil-myname-2026
NTFY_HOME_CHANNEL=vigil-myname-2026
```
...
- Or **pick a long, unguessable topic name** (`vigil-7d4f9c8b-2026`) and treat it as the shared secret. This is the lightest setup but the topic name leaks via any logs or screenshots.
...
1. Pick a topic name: `vigil-myname-2026`
2. On your phone: install the [ntfy app](https://ntfy.sh/docs/subscribe/phone/), tap **+**, enter `vigil-myname-2026`
3. On the host:
   ```bash
   echo 'NTFY_TOPIC=vigil-myname-2026' >> ~/.vigil/.env
   echo 'NTFY_ALLOWED_USERS=vigil-myname-2026' >> ~/.vigil/.env
