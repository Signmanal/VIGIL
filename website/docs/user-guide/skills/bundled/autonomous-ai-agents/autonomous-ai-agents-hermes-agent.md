---
title: "VIGIL Agent — Configure, extend, or contribute to VIGIL Agent"
...
Configure, extend, or contribute to VIGIL Agent.
...
| Path | `skills/autonomous-ai-agents/vigil-agent` |
| Version | `2.1.0` |
...
If VIGIL reports a smaller context window than your local model supports
(e.g., 128k when llama-server has `-c 262144`):

**Check if `model.context_length` is explicitly set.** VIGIL uses a
