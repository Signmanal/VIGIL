---
title: "Openclaw Migration — Migrate a user's OpenClaw customization footprint into VIGIL Agent"
sidebar_label: "Openclaw Migration"
description: "Migrate a user's OpenClaw customization footprint into VIGIL Agent"
---
...
Migrate a user's OpenClaw customization footprint into VIGIL Agent. Imports VIGIL-compatible memories, SOUL.md, command allowlists, user skills, and selected workspace assets from ~/.openclaw, then reports exactly what could not be migrated and why.
...
| Related skills | [`vigil-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-vigil-agent) |
...
Use this skill when a user wants to move their OpenClaw setup into VIGIL Agent with minimal manual cleanup.
...
- migrate VIGIL-compatible messaging settings such as `TELEGRAM_ALLOWED_USERS`, and map OpenClaw workspace settings to VIGIL working-directory configuration
...
With `--migrate-secrets`, it will also import a small allowlisted set of VIGIL-compatible secrets, currently:
