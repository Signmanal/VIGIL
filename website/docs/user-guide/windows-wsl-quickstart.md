...
- **[MCP guide → WSL → Windows Chrome](/guides/use-mcp-with-vigil#wsl2-bridge-vigil-in-wsl-to-windows-chrome)** — controlling your signed-in Windows Chrome from VIGIL in WSL.
