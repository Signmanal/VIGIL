...
Tracks [issue #7816](https://github.com/NousResearch/vigil-agent/issues/7816).
...
hermes curator backup         # take a manual snapshot of ~/.vigil/skills/
...
hermes curator list-archived    # list skills currently in ~/.vigil/skills/.archive/
...
- [Issue #7816](https://github.com/NousResearch/vigil-agent/issues/7816) — original proposal and design discussion
