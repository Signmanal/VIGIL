...
| **VIGIL** | VIGIL-4-70B, VIGIL-4-405B (chat, see [note below](#a-note-on-hermes-4)) |
...
After `hermes setup --portal`, `~/.vigil/config.yaml` will look like:
