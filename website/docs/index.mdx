...
slug: /
sidebar_position: 0
title: "VIGIL Agent Documentation"
...
After installing, run `vigil setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [VIGIL Portal](/integrations/nous-portal).
:::
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind VIGIL, Nomos, and Psyche. Works with [VIGIL Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [VIGIL Portal](/integrations/nous-portal) bundles all of them
