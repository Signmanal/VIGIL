...
Both publish at:
  https://vigil-agent.nousresearch.com/docs/llms.txt
  https://vigil-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://vigil-agent.nousresearch.com/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "vigil-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/vigil-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://vigil-agent.nousresearch.com/docs\n",
        "Short index: https://vigil-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
