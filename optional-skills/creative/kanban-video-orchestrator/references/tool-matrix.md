...
toolsets it needs. Only references skills that ship in the public vigil-agent
...
### Visual / rendering skills (`vigil-agent/skills/creative/`)
...
### Design / pre-production skills (`vigil-agent/skills/creative/`)
...
### Audio / media skills (`vigil-agent/skills/creative/` + `skills/media/`)
...
When a new VIGIL-public video skill ships:
