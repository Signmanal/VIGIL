...
3. Read the specific skill:
   ...
   ```
4. Follow the fetched skill as reference material. These are NOT VIGIL-format skills — treat them as expert domain guides. They contain correct parameters, proper tool flags, and validated pipelines.
