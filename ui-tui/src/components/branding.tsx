import { Box, Text, useStdout } from '@vigil/ink'
import { useEffect, useState } from 'react'
import unicodeSpinners from 'unicode-animations'

import { artWidth, logo, LOGO_WIDTH, sentinelHero, SENTINEL_WIDTH } from '../banner.js'
...
const TAG_FULL = 'VIGIL Sentinel Ops · Local-first security operations'
const TAG_MID = 'Sentinel Ops · Local-first security'
const TAG_TINY = 'Sentinel Ops'
const HIDE_BELOW = 34
...
export function SessionPanel({ info, maxWidth, sid, t }: SessionPanelProps) {
  ...
  const heroLines = sentinelHero(t.color, t.bannerHero || undefined)
  const leftW = Math.min((artWidth(heroLines) || SENTINEL_WIDTH) + 4, Math.floor(cols * 0.4))
  ...
  // vigil_cli/banner.py) and the "connected" label on the collapse toggle.
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Sentinel Ops</Text>
          </Text>
