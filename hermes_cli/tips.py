...
TIPS = [
    ...
    "hermes mcp serve runs VIGIL itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire VIGIL home directory.",
    ...
    "hermes gateway install sets up VIGIL as a system service (systemd/launchd).",
    ...
    "The plan skill saves markdown plans under .vigil/plans/ in the active workspace.",
    ...
    "Context files (.vigil.md, AGENTS.md) are security-scanned for prompt injection before loading.",
    ...
    "VIGIL loads project context from .vigil.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs VIGIL as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'hermes dashboard embeds the full VIGIL TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'VIGIL_WRITE_SAFE_ROOT restricts write_file and patch to a directory prefix; writes outside require approval.',
    ...
    'VIGIL_ENABLE_PROJECT_PLUGINS=1 auto-loads repo-local plugins from ./.vigil/plugins/ — trust-gated by design.',
