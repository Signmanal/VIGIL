...
DEFAULT_CONFIG = {
    ...
    "terminal": {
        ...
        # bundled VIGIL image, which drops to the `hermes` user via
    ...
    "updates": {
        # Run a full ``hermes backup``-style zip of VIGIL_HOME before every
        # ``hermes update``.  Backups land in ``<VIGIL_HOME>/backups/`` and
