...
**The native desktop app for [VIGIL Agent](../../README.md) — the self-improving AI agent from [Nous Research](https://nousresearch.com).** Same agent, same skills, same memory as the CLI and gateway, in a polished native window — chat with streaming tool output, side-by-side previews, a file browser, voice, and settings, no terminal required. Available for **macOS, Windows, and Linux**.
...
Prebuilt installers are built and distributed via [the VIGIL Desktop website.](https://vigil-agent.nousresearch.com/).
...
```powershell
# Force a clean first-launch setup
Remove-Item "$env:LOCALAPPDATA\vigil\vigil-agent\.vigil-bootstrap-complete"
# Rebuild a broken Python venv
Remove-Item -Recurse -Force "$env:LOCALAPPDATA\vigil\vigil-agent\venv"
```

> The default VIGIL home on Windows is `%LOCALAPPDATA%\vigil`. Set the `VIGIL_HOME` env var if you've relocated it.
...
- 📖 [Documentation](https://vigil-agent.nousresearch.com/docs/)
