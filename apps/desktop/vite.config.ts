...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\vigil\vigil-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@vigil/shared': path.resolve(__dirname, '../shared/src'),
  ...
  test: {
    ...
    exclude: [...configDefaults.exclude, 'build/native-deps/**', 'release/**']
  }
})
