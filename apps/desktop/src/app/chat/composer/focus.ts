...
const FOCUS_EVENT = 'vigil:composer-focus'
const INSERT_EVENT = 'vigil:composer-insert'
const INSERT_REFS_EVENT = 'vigil:composer-insert-refs'
const VOICE_TOGGLE_EVENT = 'vigil:composer-voice-toggle'
