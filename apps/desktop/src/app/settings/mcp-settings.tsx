...
import { getVIGILConfigRecord, type VIGILGateway, saveVIGILConfig } from '@/hermes'
...
function getServers(config: VIGILConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveVIGILConfig(nextConfig)
