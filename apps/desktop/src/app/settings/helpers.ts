...
export function getNested(obj: VIGILConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: VIGILConfigRecord, path: string, value: unknown): VIGILConfigRecord {
...
function personalityOptions(config: VIGILConfigRecord): string[] {
