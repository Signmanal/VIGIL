...
export const zhHant = defineLocale({
  ...
  artifacts: {
    ...
    refresh: '重新整理報告',
    refreshing: '正在重新整理報告',
    indexing: '正在索引最近工作階段的報告',
    tabReports: '報告',
    tabAll: '全部',
    tabImages: '圖片',
    tabFiles: '檔案',
    tabLinks: '連結',
    noArtifactsTitle: '找不到報告',
    noArtifactsDesc: '對話和排程工作產生的報告會集中顯示在這裡；相關圖片、檔案和連結保留在其他標籤中。',
    failedLoad: '報告載入失敗',
    openFailed: '開啟失敗',
    preview: '預覽',
    previewFailed: '預覽失敗',
  ...
  updates: {
    ...
    applyingBody:
      'VIGIL 更新程式會在自己的視窗中接管，並在完成後自動重新開啟 VIGIL。更新期間請勿自行重新開啟 VIGIL。',
