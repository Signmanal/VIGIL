...
export const zhHant = defineLocale({
  ...
  artifacts: {
    ...
    statSessions: '來源工作階段',
    statRelated: '關聯輸出',
    retentionTitle: '歸檔與保留策略',
    retentionPolicy: (days, limit) => `預設顯示最近 ${days} 天且最多 ${limit} 筆產物；歸檔只新增隱藏狀態。`,
    retentionScope: '來源索引記錄和磁碟實際檔案都會保留，不會刪除。',
    retentionPending: count => `${count} 筆歷史產物可歸檔隱藏`,
    retentionHidden: count => `已歸檔隱藏 ${count} 筆產物`,
    retentionCleanNow: '歸檔舊記錄',
    retentionRestore: '恢復歸檔記錄',
    itemsReport: '份報告',
    itemsImage: '張圖片',
    itemsLink: '個連結',
    itemsFile: '個檔案',
