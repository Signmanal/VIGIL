...
export const zh: Translations = {
  ...
  artifacts: {
    ...
    statSessions: '来源会话',
    statRelated: '关联输出',
    retentionTitle: '归档与保留策略',
    retentionPolicy: (days, limit) => `默认显示最近 ${days} 天且最多 ${limit} 条产物；归档只新增隐藏状态。`,
    retentionScope: '源索引记录和磁盘真实文件都会保留，不会删除。',
    retentionPending: count => `${count} 条历史产物可归档隐藏`,
    retentionHidden: count => `已归档隐藏 ${count} 条产物`,
    retentionCleanNow: '归档旧记录',
    retentionRestore: '恢复归档记录',
    itemsReport: '份报告',
    itemsImage: '张图片',
    itemsLink: '个链接',
    itemsFile: '个文件',
