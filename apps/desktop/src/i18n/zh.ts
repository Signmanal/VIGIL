...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: '正在加载 XCLAW 设置',
      loadingSessions: '正在加载最近会话',
      startingDesktopConnection: '正在启动桌面连接',
      startingVIGILDesktop: '正在启动 XCLAW 桌面版…'
    },
    errors: {
      backgroundExited: 'XCLAW 后台进程已退出。',
      backgroundExitedDuringStartup: 'XCLAW 后台进程在启动期间退出。',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '你的 XCLAW 后端早于当前桌面构建，可能无法正常工作。请更新以保持一致。',
    ...
    errors: {
      ...
      methodNotAllowed: '桌面后端拒绝了该请求 (405 Method Not Allowed)。请尝试重启 XCLAW Desktop。',
    ...
    native: {
      ...
      rejectAction: '拒绝',
      inputTitle: '需要输入',
      inputBody: 'XCLAW 正在等待你的回应。',
      turnDoneTitle: 'XCLAW 已完成',
      turnDoneBody: '回复已就绪。',
      turnErrorTitle: '本轮失败',
  ...
  settings: {
    ...
    resetConfirm: '将所有设置恢复为 XCLAW 默认值？',
    exportFailed: '导出失败',
    resetFailed: '重置失败',
    nav: {
      providers: '提供方',
    ...
    notifications: {
      ...
      focusedHint: '完成提醒仅在 XCLAW 处于后台时触发。',
      kinds: {
        approval: {
          label: '需要批准',
        ...
        input: {
          label: '需要输入',
          description: 'XCLAW 提出了问题，或需要密码或密钥。'
        },
        turnDone: {
          label: '回复就绪',
          description: 'XCLAW 在后台时完成了一轮对话。'
        },
        turnError: {
          label: '本轮失败',
          description: '本轮以错误结束。'
    ...
    appearance: {
      ...
      colorMode: '颜色模式',
      colorModeDesc: '选择固定模式，或让 XCLAW 跟随系统设置。',
      ...
      pet: {
        title: '宠物',
        intro:
          '领养一只悬浮在应用上的 petdex 动画宠物，它会根据 XCLAW 的状态做出反应——工具执行时奔跑、成功时欢呼、出错时沮丧。',
        restartHint: '宠物功能需要重启——当前运行的应用在此功能加入前启动。请退出并重新打开 XCLAW，然后回到此处。',
        scaleTitle: '大小',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: '当 XCLAW 需要本地时间上下文时使用。留空则使用系统时区。',
      agent: {
        imageInputMode: '控制图片附件如何发送给模型。',
        maxTurns: 'XCLAW 停止一次运行前工具调用轮次的上限。'
      },
      terminal: {
        cwd: '工具与终端操作的默认项目目录。',
      ...
      fileReadMaxChars: 'XCLAW 单次文件读取可读取的最大字符数。',
      approvals: {
        mode: 'XCLAW 如何处理需要显式审批的命令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'XCLAW 从应用内更新时（无终端提示），保留本地源码修改（暂存）或丢弃（放弃）。通过终端更新时始终会询问。'
      }
    }),
    about: {
      ...
      uninstall: {
        heading: '卸载与数据管理',
        summaryTitle: '本机组件清理',
        summaryDesc: '可选择仅移除桌面应用，或同时移除 Agent 与本地数据。默认不会执行任何卸载操作。',
        showOptions: '显示卸载选项',
        hideOptions: '收起卸载选项',
        checking: '正在检查已安装内容...',
        confirmTitle: '确认卸载',
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        'XCLAW Desktop 默认会启动自己的本地网关。当你希望此应用控制另一台机器上或可信代理后的现有 XCLAW 后端时，可以使用远程网关。下面可按 profile 指定各自的远程主机。',
      appliesTo: '应用于',
      ...
      localTitle: '本地网关',
      localDesc: '在 localhost 启动私有 XCLAW 后端。这是默认方式，并且可离线工作。',
      remoteTitle: '远程网关',
      remoteDesc:
        '将此桌面外壳连接到远程 XCLAW 后端。托管网关使用 OAuth 或用户名密码；自托管网关也可能使用会话 token。',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'XCLAW Desktop 将使用已保存设置重新连接。',
      savedMessage: '已保存，下一次重启生效。',
      connectedTo: (baseUrl, version) => `已连接到 ${baseUrl}${version ? ` · XCLAW ${version}` : ''}`,
    ...
    providers: {
      ...
      intro: '使用订阅登录，无需复制 API 密钥。XCLAW 会在应用中为你完成浏览器登录。',
      connected: '已连接',
      collapse: '收起',
    ...
    toolsets: {
      ...
      ready: '就绪',
      nousIncluded: '包含在 Nous 订阅中；登录 XCLAW Portal 即可激活。',
  ...
  skills: {
    ...
    searchMarket: '搜索 skills.sh 或粘贴 owner/repo…',
    refresh: '刷新技能',
    refreshing: '正在刷新技能',
    loading: '正在加载能力…',
    noSkillsTitle: '未找到技能',
    ...
    marketTitle: '技能市场',
    marketDesc: '搜索已配置的 Skill Hub，将社区技能安装到当前配置档案，然后刷新本地技能列表。',
    marketOpen: '打开',
    marketSource: '来源',
    marketAllSources: '全部来源',
    marketLoading: '正在搜索技能市场…',
    marketSourcesTitle: '已配置来源',
    marketSourceReady: '可用',
    marketSourceUnavailable: '不可用',
    marketSourceRateLimited: '已限流',
    marketFeaturedTitle: '当前来源技能',
    marketFeaturedDesc: '展示选中来源返回的技能列表，可直接安装到当前配置档案。',
    marketEmptyTitle: '搜索市场',
    marketEmptyDesc: '输入 browser、security、docs 等主题，或粘贴 skills.sh 上的 owner/repo 标识。',
    marketNoResultsTitle: '没有市场结果',
    marketNoResultsDesc: '尝试更宽泛的搜索、切换来源，或直接安装 owner/repo 标识。',
    marketInstall: '安装',
    marketInstalling: '安装中…',
    marketInstalled: '已安装',
    marketInstallStarted: identifier => `${identifier} 已开始安装。后台 action 完成后刷新技能列表。`,
    marketInstallFailed: identifier => `安装 ${identifier} 失败`,
    marketSearchFailed: '技能市场搜索失败',
    marketDirectInstall: identifier => `直接安装 ${identifier}`,
    marketTrust: trust => `可信级别：${trust}`,
    marketSourceLabel: source => `来源：${source}`
  },

  agents: {
    close: '关闭专家',
    title: '专家工作台',
    subtitle: '监控运行中的子专家，并管理会话可选择的专家角色。',
    manageRoles: '管理专家角色',
    roleHint: '可复用专家使用配置档案承载：编辑 SOUL.md 后，在对话侧栏选择对应档案即可切换角色。',
    currentExpertTitle: '当前活跃专家',
    currentExpertDesc: '这里展示当前对话正在使用的专家配置；当某个回合派发任务时，子专家会在下方继续显示。',
    activeBadge: '活跃',
    manageCurrentExpert: '编辑角色',
    currentExpertNoDescription: '该专家暂未填写描述，可在角色管理中编辑 SOUL.md 或补充配置档案说明。',
    skillMetric: (enabled, total) => `${enabled}/${total} Skill`,
    toolMetric: count => `${count} 工具`,
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: '请重启 XCLAW 以使用宠物功能——当前后端版本过旧。',
      empty: '没有匹配的宠物。',
      turnOff: '关闭',
      turnOn: '开启',
      installed: '已安装',
    ...
    generatePet: {
      ...
      staleBackend: '请更新 XCLAW 以生成宠物。',
      backgroundHint: '你可以关闭此窗口——完成后 XCLAW 会通知你。',
    ...
    nav: {
      ...
      settings: { title: '设置', detail: '配置 XCLAW 桌面端' },
      skills: { title: '插件与工具', detail: '启用技能、工具集、MCP 服务与提供方' },
      messaging: { title: '消息平台', detail: '配置 Telegram、Slack、Discord 等' },
      artifacts: { title: '产物中心', detail: '浏览会话报告、文件、图片与链接' }
    },
    sectionEntries: {
    ...
    hermesActiveSessions: (version, count) => `XCLAW ${version} · 活跃会话 ${count}`,
    restartGateway: '重启网关',
  ...
  messaging: {
    ...
    platformIntro: {
      ...
      signal: '在可访问的位置运行 signal-cli REST 桥接，然后把 XCLAW 指向该 URL 和已注册的电话号码。',
      whatsapp: '启动 XCLAW 自带的 WhatsApp 桥接，首次运行时扫描二维码，然后启用该平台。',
      bluebubbles:
        '在装有 iMessage 的 Mac 上运行 BlueBubbles Server，暴露其 API，然后用服务器密码把 XCLAW 指向该 URL。',
      ...
      weixin:
        '运行 `vigil gateway setup`，选择 Weixin，然后使用个人微信账号扫描并确认二维码。XCLAW 会通过腾讯 iLink Bot API 连接并保存凭据。',
      qqbot: '在 QQ 开放平台 (q.qq.com) 注册一个应用，复制 App ID 和 Client Secret。',
      api_server:
        '把 XCLAW 暴露为兼容 OpenAI 的 API。设置一个鉴权密钥，然后把 Open WebUI / LobeChat 等指向 host:port。',
  ...
  profiles: {
    ...
    enabledSkills: (enabled, total) => `已启用 ${enabled}/${total}`,
    env: 'env',
    defaultBadge: '默认',
    rename: '重命名',
    copySetup: '复制安装命令',
    setupCommandHint: '复制的是此配置档案的 CLI setup 命令，可直接粘贴到终端执行；技能市场安装请在市场卡片中点击安装。',
    copying: '复制中…',
    modelLabel: '模型',
    skillsLabel: '技能',
    notSet: '未设置',
    ...
    editProfile: '编辑专家配置',
    editProfileDesc: '名称、起始技能、MCP 和 SOUL.md 会作为草稿统一保存。',
    unsavedChanges: '有未保存的更改',
    ...
    saveSoul: '保存 SOUL.md',
    resetChanges: '重置更改',
    defaultNameLocked: 'default 是根配置档案；这里保存的是展示名称，内部标识、路径和命令仍保持 default。',
    deleteTitle: '删除配置档案？',
    deleteDescPrefix: '这将删除 ',
    deleteDescMid: ' 并移除其 ',
    deleteDescSuffix: ' 目录。此操作无法撤销。',
    deleting: '删除中…',
    createDesc: '配置档案是相互独立的 XCLAW 环境：各自拥有独立的配置、技能和 SOUL.md。',
    nameLabel: '名称',
    cloneFrom: '克隆来源',
    cloneFromNone: '无（空白）',
    cloneFromDesc: '从选中的来源配置档案复制配置、技能和 SOUL.md。',
    startingSkills: '起始技能',
    startingSkillsDesc: source => `选择创建后保持启用的技能。当前从 ${source} 加载；清空则创建最小化智能体。`,
    profileSkillsDesc: '选择此配置档案自己的 skills 目录中启用哪些技能；不会直接修改 default。',
    startingMcpDesc: source => `选择从 ${source} 复制哪些 MCP 服务器和工具。`,
    profileMcpDesc: '选择此配置档案启用哪些 MCP 服务器和工具。',
    searchProfileSkills: '搜索技能名称、分类或描述…',
    searchProfileMcp: '搜索 MCP 名称、命令或 URL…',
    loadingSkills: '正在加载技能…',
    loadingMcp: '正在加载 MCP 服务器…',
    noSkillsAvailable: '此来源配置档案暂无可用技能。',
    noSkillSearchResults: '没有匹配的技能。',
    noMcpAvailable: '此来源配置档案暂无 MCP 服务器配置。',
    noProfileMcpAvailable: '此配置档案暂无 MCP 服务器配置。',
    noMcpSearchResults: '没有匹配的 MCP 服务器。',
    skillsSelected: (selected, total) => `已选 ${selected}/${total}`,
    selectAllSkills: '全选',
    clearSkills: '清空',
    ...
    failedLoadMcp: '加载 MCP 服务器失败',
    failedSaveMcp: '保存 MCP 服务器失败',
  ...
  cron: {
    ...
    newCron: '新建自动化',
    emptyDescNew: '按 cron 表达式排程一个提示词。XCLAW 会运行它，并把结果发送到你选择的目的地。',
  ...
  artifacts: {
    ...
    statSessions: '来源会话',
    statRelated: '关联输出',
    retentionTitle: '删除与保留策略',
    retentionPolicy: (days, limit) =>
      `当前显示最近 ${days} 天且最多 ${limit} 条产物；删除只针对产物中心识别到的本机生成产物文件。`,
    retentionScope: '外链、远程路径、引用文件、技能源码不会删除。',
    retentionPending: count => `${count} 个本机生成产物文件可删除`,
    retentionHidden: count => `已删除并隐藏 ${count} 条产物记录`,
    retentionDaysLabel: '保留天数',
    retentionLimitLabel: '最多条数',
    retentionSave: '保存策略',
    retentionResetDefault: '恢复默认',
    retentionSaved: (days, limit) => `保留策略已更新为最近 ${days} 天、最多 ${limit} 条。`,
    retentionCleanNow: '删除旧产物文件',
    retentionRestore: '恢复隐藏记录',
    retentionDeleteConfirm: count => `确认将 ${count} 个本机生成产物文件移到废纸篓？`,
    retentionDeleteSucceeded: count => `已将 ${count} 个生成产物文件移到废纸篓。`,
    retentionDeletePartial: (deleted, failed) => `已删除 ${deleted} 个生成产物文件，${failed} 个删除失败。`,
    itemsReport: '份报告',
    itemsImage: '张图片',
    itemsLink: '个链接',
    itemsFile: '个文件',
  ...
  sidebar: {
    ...
    projects: '项目',
    addProject: '添加项目',
    addProjectPathPrompt: '请输入项目目录路径',
    noProjects: '添加项目目录后，可从左侧直接在该项目中启动会话。',
    sessions: '会话',
    cronJobs: '自动化',
  ...
  composer: {
    ...
    placeholderStarting: '正在启动 XCLAW…',
    placeholderReconnecting: '正在重新连接 XCLAW…',
    ...
    attachUrlDesc: 'XCLAW 将抓取该页面并作为本回合的上下文。',
  ...
  updates: {
    ...
    unsupportedMessage: '此版本的 XCLAW 无法在应用内自行更新。',
    connectionRetry: '请检查网络连接后重试。',
    latestBody: '你正在运行最新版本。',
    latestBodyRelease: '你正在运行最新的客户端版本。',
    ...
    guiSkewBody:
      '后端已更新，但此桌面应用包未更改。请更新或重新安装 XCLAW 桌面应用（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '复制',
    copied: '已复制',
    done: '完成',
    applyingBody: 'XCLAW 更新器会在自己的窗口中接管，并在完成后自动重新打开 XCLAW。更新期间请不要自行重新打开 XCLAW。',
    applyingBodyBackend: '远程后端正在应用更新并将重启。恢复后 XCLAW 会自动重新连接。',
    applyingClose: '此窗口会在更新期间关闭，随后 XCLAW 会自动重新打开。',
    errorTitle: '更新未完成',
  ...
  install: {
    ...
    failedTitle: '安装失败',
    settingUpTitle: '正在设置 XCLAW Agent',
    finishingTitle: '正在收尾',
    failedDesc:
      '某个安装步骤失败。在 Windows 上，如果另一个 XCLAW CLI 或桌面实例正在运行，可能会出现这种情况。请停止正在运行的 XCLAW 实例后重试。可查看下面的详情或 desktop 日志中的完整记录。',
    activeDesc: '这是一次性设置。XCLAW 安装器正在下载依赖并配置你的机器。之后启动会跳过此步骤。',
  ...
  onboarding: {
    headerTitle: '开始设置 XCLAW Agent',
    headerDesc: '连接模型提供方即可开始对话。大多数选项只需一次点击。',
    preparingInstall: 'XCLAW 正在完成安装。首次运行通常不到一分钟。',
    starting: '正在启动 XCLAW…',
    ...
    recommended: '推荐',
    connected: '已连接',
    featuredPitch: '一个订阅，300+ 前沿模型 — 运行 XCLAW 的推荐方式',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: '自托管',
        description: '将 XCLAW 指向本地或自托管的 OpenAI 兼容端点 (vLLM、llama.cpp、Ollama 等)。'
      }
    },
    backToSignIn: '返回登录',
    getKey: '获取密钥',
    ...
    flowSubtitles: {
      ...
      device_code: '在浏览器中打开验证页面 — XCLAW 会自动连接',
      loopback: '打开浏览器登录 — XCLAW 会自动连接',
    ...
    authorizeThere: '请在那里授权 XCLAW。',
    copyAuthCode: '复制授权码并粘贴到下面。',
    pasteAuthCode: '粘贴授权码',
    reopenAuthPage: '重新打开授权页面',
    autoBrowser: provider => `已在浏览器中打开 ${provider}。请在那里授权 XCLAW，连接会自动完成，无需复制或粘贴。`,
  ...
  preview: {
    ...
    largeTitle: '此文件较大',
    largeBody: (label, size) => `${label} 大小为 ${size}。XCLAW 只会显示前 512 KB。`,
    previewAnyway: '仍然预览',
    ...
    web: {
      ...
      failedToLoad: '预览加载失败',
      tryAgain: '重试',
      restarting: 'XCLAW 正在重启...',
      askRestart: '让 XCLAW 重启服务器',
      lookingRestart: taskId => `XCLAW 正在查找要重启的预览服务器 (${taskId})`,
      restartingTitle: '正在重启预览服务器',
      restartingMessage: 'XCLAW 正在后台工作。可在预览控制台查看进度。',
      ...
      finishedRestarting: message => `XCLAW 已完成预览服务器重启${message ? `: ${message}` : ''}`,
      failedRestarting: message => `服务器重启失败：${message}`,
      unknownError: '未知错误',
      restartedTitle: '预览服务器已重启',
      reloadingNow: '正在重新加载预览。',
      restartFailedTitle: '预览重启失败',
      restartFailedMessage: 'XCLAW 无法重启服务器。',
      stillWorking: 'XCLAW 仍在工作，但还没有收到重启结果。服务器命令可能正在前台运行。',
  ...
  assistant: {
    ...
    approval: {
      gatewayDisconnected: 'XCLAW 网关未连接',
      sendFailed: '无法发送审批响应',
      run: '运行',
      command: '命令',
      moreOptions: '更多审批选项',
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.vigil/config.yaml)。XCLAW 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
  ...
  prompts: {
    ...
    sudoTitle: '管理员密码',
    sudoDesc: 'XCLAW 需要你的 sudo 密码来运行特权命令。它只会发送给你的本地 agent。',
    sudoPlaceholder: 'sudo 密码',
    secretTitle: '需要密钥',
    secretDesc: 'XCLAW 需要一个凭据才能继续。',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重启 XCLAW 桌面版后可使用保存图片。',
    restartToSaveImages: '重启 XCLAW 桌面版以保存图片',
