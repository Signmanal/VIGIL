...
export const zh: Translations = {
  ...
  commandCenter: {
    ...
    nav: {
      ...
      artifacts: { title: '报告中心', detail: '浏览生成的报告与输出' }
    },
    sectionEntries: {
  ...
  artifacts: {
    ...
    refresh: '刷新报告',
    refreshing: '正在刷新报告',
    indexing: '正在索引最近会话的报告',
    tabReports: '报告',
    tabAll: '全部',
    tabImages: '图片',
    tabFiles: '文件',
    tabLinks: '链接',
    noArtifactsTitle: '未找到报告',
    noArtifactsDesc: '对话和已安排任务生成的报告会集中显示在这里；相关图片、文件、链接保留在其他标签中。',
    failedLoad: '报告加载失败',
    openFailed: '打开失败',
    preview: '预览',
    previewFailed: '预览失败',
  ...
  updates: {
    ...
    applyingBody:
      'VIGIL 更新器会在自己的窗口中接管，并在完成后自动重新打开 VIGIL。更新期间请不要自行重新打开 VIGIL。',
