...
export const ja = defineLocale({
  ...
  artifacts: {
    ...
    statSessions: '元セッション',
    statRelated: '関連出力',
    retentionTitle: '保持と削除ポリシー',
    retentionPolicy: (days, limit) =>
      `直近 ${days} 日、最大 ${limit} 件の出力を表示します。削除対象は生成されたローカル成果物ファイルのみです。`,
    retentionScope: '外部リンク、リモートパス、参照元ファイル、スキルのソースは削除されません。',
    retentionPending: count => `${count} 件の生成済みローカル出力ファイルを削除できます`,
    retentionHidden: count => `${count} 件の削除済み出力レコードを非表示中`,
    retentionDaysLabel: '保持日数',
    retentionLimitLabel: '最大件数',
    retentionSave: 'ポリシーを保存',
    retentionResetDefault: '既定に戻す',
    retentionSaved: (days, limit) => `保持ポリシーを直近 ${days} 日、最大 ${limit} 件に更新しました。`,
    retentionCleanNow: '古い出力ファイルを削除',
    retentionRestore: '非表示レコードを復元',
    retentionDeleteConfirm: count => `${count} 件の生成済みローカル出力ファイルをゴミ箱に移動しますか？`,
    retentionDeleteSucceeded: count => `${count} 件の生成済み出力ファイルをゴミ箱に移動しました。`,
    retentionDeletePartial: (deleted, failed) =>
      `${deleted} 件の生成済み出力ファイルをゴミ箱に移動しました。${failed} 件は失敗しました。`,
    itemsReport: 'レポート',
    itemsImage: '画像',
    itemsLink: 'リンク',
    itemsFile: 'ファイル',
  ...
  preview: {
    ...
    revealFile: 'ファイルの場所を表示',
    expandPreview: 'プレビューを拡大',
    collapsePreview: 'プレビューを戻す',
    webPreview: 'Web',
    webPreviewMode: 'Web ページとしてプレビュー',
    sourceMode: 'ソースプレビューを表示',
    openFailed: 'プレビュー対象を開けませんでした',
