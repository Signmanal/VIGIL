...
export const ja = defineLocale({
  ...
  artifacts: {
    ...
    statSessions: '元セッション',
    statRelated: '関連出力',
    retentionTitle: '保持とアーカイブ',
    retentionPolicy: (days, limit) => `直近 ${days} 日、最大 ${limit} 件の出力を表示します。アーカイブは非表示状態を追加するだけです。`,
    retentionScope: '元の記録と実ファイルは保持され、削除されません。',
    retentionPending: count => `${count} 件の古い出力をアーカイブできます`,
    retentionHidden: count => `${count} 件のアーカイブ済み出力を非表示中`,
    retentionCleanNow: '古い記録をアーカイブ',
    retentionRestore: 'アーカイブを復元',
    itemsReport: 'レポート',
    itemsImage: '画像',
    itemsLink: 'リンク',
    itemsFile: 'ファイル',
