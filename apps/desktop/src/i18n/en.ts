...
export const en: Translations = {
  ...
  boot: {
    ready: 'XCLAW Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading XCLAW settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingVIGILDesktop: 'Starting XCLAW Desktop…'
    },
    errors: {
      backgroundExited: 'XCLAW background process exited.',
      backgroundExitedDuringStartup: 'XCLAW background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your XCLAW backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting XCLAW Desktop.',
    ...
    native: {
      ...
      inputBody: 'XCLAW is waiting for your response.',
      turnDoneTitle: 'XCLAW finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to XCLAW defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while XCLAW is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'XCLAW asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while XCLAW was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let XCLAW follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what XCLAW is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen XCLAW, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    config: {
      ...
      loading: 'Loading XCLAW configuration...',
    ...
    gateway: {
      ...
      intro:
        'XCLAW Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running XCLAW backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private XCLAW backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote XCLAW backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'XCLAW Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · XCLAW ${version}` : ''}`,
    ...
    model: {
      ...
      resetUnavailableAux: 'Reset unavailable tasks',
      auxiliaryProviderUnavailable: (count, tasks, provider) =>
        `${count} auxiliary task${count === 1 ? '' : 's'} (${tasks}) use ${provider}, which is not connected or configured.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. XCLAW runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Nous subscription — sign in to XCLAW Portal to activate.',
  ...
  skills: {
    ...
    marketSourcesTitle: 'Configured sources',
    marketSourceReady: 'Available',
    marketSourceUnavailable: 'Unavailable',
    marketSourceRateLimited: 'Rate limited',
    marketFeaturedTitle: 'Skills from this source',
    marketFeaturedDesc: 'Browse the selected source and install any listed skill into the current profile.',
  ...
  agents: {
    ...
    agentsCount: count => `${count} ${count === 1 ? 'expert' : 'experts'}`,
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart XCLAW to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update XCLAW to generate pets.',
      backgroundHint: 'You can close this — XCLAW will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure XCLAW desktop' },
    ...
    hermesActiveSessions: (version, count) => `XCLAW ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    enabledSkills: (enabled, total) => `${enabled}/${total} enabled`,
    env: 'env',
    defaultBadge: 'Default',
    rename: 'Rename',
    copySetup: 'Copy setup',
    setupCommandHint:
      'Copies this profile setup command. Paste it in a terminal to run that profile; use market cards to install skills.',
    copying: 'Copying...',
    modelLabel: 'Model',
    skillsLabel: 'Skills',
    notSet: 'Not set',
    ...
    editProfileDesc: 'Name, starting skills, MCP, and SOUL.md are saved together from one draft.',
    unsavedChanges: 'Unsaved changes',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent XCLAW environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
    ...
    profileSkillsDesc: "Choose which skills are enabled from this profile's own skills directory.",
    startingMcpDesc: source => `Choose which MCP servers and tools are copied from ${source}.`,
    profileMcpDesc: 'Choose which MCP servers and tools are enabled for this profile.',
    searchProfileSkills: 'Search skill names, categories, or descriptions...',
    searchProfileMcp: 'Search MCP names, commands, or URLs...',
    loadingSkills: 'Loading skills...',
    loadingMcp: 'Loading MCP servers...',
    noSkillsAvailable: 'No skills are available from this source profile.',
    noSkillSearchResults: 'No matching skills.',
    noMcpAvailable: 'No MCP servers are configured in this source profile.',
    noProfileMcpAvailable: 'No MCP servers are configured for this profile.',
    noMcpSearchResults: 'No matching MCP servers.',
    ...
    failedLoadMcp: 'Failed to load MCP servers',
    failedSaveMcp: 'Failed to save MCP servers',
  ...
  cron: {
    ...
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. XCLAW will run it and deliver results to the destination you pick.',
    ...
    failedLoad: 'Failed to load automation',
  ...
  artifacts: {
    ...
    noArtifactsDesc: 'Reports, images, files, and links generated by chats and scheduled runs appear here.',
    ...
    retentionTitle: 'Retention and cleanup',
    retentionPolicy: (days, limit) => `Keeps the last ${days} days and up to ${limit} outputs. Cleanup hides old index rows only.`,
    retentionScope: 'Real files are never deleted by this cleanup.',
    retentionPending: count => `${count} old output${count === 1 ? '' : 's'} ready to hide`,
    retentionHidden: count => `${count} hidden output${count === 1 ? '' : 's'}`,
    retentionCleanNow: 'Clean now',
    retentionRestore: 'Restore hidden',
    itemsReport: 'reports',
    itemsImage: 'images',
    itemsLink: 'links',
    itemsFile: 'files',
    ...
    colTitleReport: 'Report',
    colTitleLink: 'Link title',
    colTitleFile: 'Name',
    colTitleDefault: 'Title / name',
    colLocationReport: 'Report path',
    colLocationLink: 'URL',
  ...
  sidebar: {
    ...
    addProjectPathPrompt: 'Enter a project folder path',
    noProjects: 'Add a project folder to start sessions from it.',
    sessions: 'Sessions',
    cronJobs: 'Automation',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting XCLAW...',
    placeholderReconnecting: 'Reconnecting to XCLAW…',
    ...
    attachUrlDesc: 'XCLAW will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    subagents: count => `${count} Sub-expert${count === 1 ? '' : 's'}`,
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating XCLAW…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting XCLAW…',
    ...
    unsupportedMessage: 'This version of XCLAW can’t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'You’re running the latest version.',
    latestBodyRelease: 'You’re running the latest desktop app version.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the XCLAW desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The XCLAW updater takes over in its own window and reopens XCLAW automatically when it’s done. Please don’t reopen XCLAW yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. XCLAW reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then XCLAW reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'XCLAW needs a one-time install',
    ...
    settingUpTitle: 'Setting up XCLAW Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another XCLAW CLI or desktop instance is running. Stop any running XCLAW instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The XCLAW installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with XCLAW Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'XCLAW is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting XCLAW…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run XCLAW',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point XCLAW at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — XCLAW connects automatically',
      loopback: 'Opens your browser to sign in — XCLAW connects automatically',
    ...
    authorizeThere: 'Authorize XCLAW there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize XCLAW there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'XCLAW inference gateway status',
      agents: 'Experts',
      closeAgents: 'Close experts',
      openAgents: 'Open experts',
      subagents: count => `${count} sub-expert${count === 1 ? '' : 's'}`,
      failed: count => `${count} failed`,
      running: count => `${count} running`,
      cron: 'Automation',
      openCron: 'Open automation',
      turnRunning: 'Running',
  ...
  preview: {
    ...
    webPreview: 'Web',
    webPreviewMode: 'Preview as webpage',
    sourceMode: 'Show source preview',
    openFailed: 'Could not open preview target',
    ...
    largeBody: (label, size) => `${label} is ${size}. XCLAW will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'XCLAW is restarting...',
      askRestart: 'Ask XCLAW to restart the server',
      lookingRestart: taskId => `XCLAW is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'XCLAW is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `XCLAW finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'XCLAW could not restart the server.',
      stillWorking:
        'XCLAW is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'XCLAW is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'XCLAW gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.vigil/config.yaml). XCLAW won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'XCLAW needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'XCLAW needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart XCLAW Desktop to use Save Image.',
    restartToSaveImages: 'Restart XCLAW Desktop to save images',
