...
export const en: Translations = {
  ...
  boot: {
    ready: 'VIGIL Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading VIGIL settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingVIGILDesktop: 'Starting VIGIL Desktop…'
    },
    errors: {
      backgroundExited: 'VIGIL background process exited.',
      backgroundExitedDuringStartup: 'VIGIL background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your VIGIL backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting VIGIL Desktop.',
    ...
    native: {
      ...
      inputBody: 'VIGIL is waiting for your response.',
      turnDoneTitle: 'VIGIL finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to VIGIL defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while VIGIL is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'VIGIL asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while VIGIL was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let VIGIL follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what VIGIL is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen VIGIL, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'VIGIL checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading VIGIL configuration...',
    ...
    gateway: {
      ...
      intro:
        'VIGIL Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running VIGIL backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      restartingMessage: 'VIGIL Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · VIGIL ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. VIGIL runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  agents: {
    ...
    subtitle: 'Monitor running subagents and manage reusable roles for chat sessions.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart VIGIL to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update VIGIL to generate pets.',
      backgroundHint: 'You can close this — VIGIL will notify you when it’s done.',
    ...
    hermesActiveSessions: (version, count) => `VIGIL ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent VIGIL environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New scheduled task',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. VIGIL will run it and deliver results to the destination you pick.',
    ...
    failedLoad: 'Failed to load scheduled tasks',
    failedUpdate: 'Failed to update scheduled task',
    failedTrigger: 'Failed to trigger scheduled task',
    failedDelete: 'Failed to delete scheduled task',
    failedSave: 'Failed to save scheduled task',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting VIGIL...',
    placeholderReconnecting: 'Reconnecting to VIGIL…',
    ...
    attachUrlDesc: 'VIGIL will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating VIGIL…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting VIGIL…',
    ...
    unsupportedMessage: 'This version of VIGIL can’t update itself from inside the app.',
    ...
    manualBody: 'You installed VIGIL from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'VIGIL will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the VIGIL desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The VIGIL updater takes over in its own window and reopens VIGIL automatically when it’s done. Please don’t reopen VIGIL yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. VIGIL reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then VIGIL reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'VIGIL needs a one-time install',
    ...
    settingUpTitle: 'Setting up VIGIL Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another VIGIL CLI or desktop instance is running. Stop any running VIGIL instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The VIGIL installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with VIGIL Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'VIGIL is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting VIGIL…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run VIGIL',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point VIGIL at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — VIGIL connects automatically',
      loopback: 'Opens your browser to sign in — VIGIL connects automatically',
    ...
    authorizeThere: 'Authorize VIGIL there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize VIGIL there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'VIGIL inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. VIGIL will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'VIGIL is restarting...',
      askRestart: 'Ask VIGIL to restart the server',
      lookingRestart: taskId => `VIGIL is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'VIGIL is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `VIGIL finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'VIGIL could not restart the server.',
      stillWorking:
        'VIGIL is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'VIGIL is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'VIGIL gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.vigil/config.yaml). VIGIL won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'VIGIL needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'VIGIL needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart VIGIL Desktop to use Save Image.',
    restartToSaveImages: 'Restart VIGIL Desktop to save images',
