...
const desktopWindow = window as unknown as { vigilDesktop?: Window['vigilDesktop'] }
const initialVIGILDesktop = desktopWindow.vigilDesktop

function installDesktopBridge(partial: Partial<Window['vigilDesktop']> = {}) {
  desktopWindow.vigilDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['vigilDesktop']
}
...
afterEach(() => {
  ...
  if (initialVIGILDesktop) {
    desktopWindow.vigilDesktop = initialVIGILDesktop
  } else {
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['vigilDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['vigilDesktop']['openExternal'] })
