...
const SIDEBAR_PINNED_STORAGE_KEY = 'vigil.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'vigil.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'vigil.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'vigil.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'vigil.desktop.sessionOrder'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'vigil:focus-session-search'
