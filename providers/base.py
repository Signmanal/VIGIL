...
def _profile_user_agent() -> str:
    """Return a ``vigil-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from vigil_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"vigil-cli/{_ver}"
    except Exception:
        return "vigil-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # vigil-cli UA so the catalog endpoint is reachable.
