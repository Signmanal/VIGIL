...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_vigil_home()`` helper (VIGIL_HOME-aware and
...
RULES_FILE = get_vigil_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_vigil_home() / "feishu_comment_pairing.json"
