...
def _load_config() -> dict:
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "vigil"),
        "oss": {},
    }
    ...
    config_path = get_vigil_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent_id = self._config.get("agent_id", "vigil")
