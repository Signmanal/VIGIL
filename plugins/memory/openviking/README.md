...
| `OPENVIKING_AGENT` | `hermes` | VIGIL peer ID in OpenViking, used for peer-scoped memories |
...
file URIs, such as
`viking://user/peers/vigil/memories/preferences/mem_abc123.md` or the canonical
`viking://user/default/peers/vigil/memories/preferences/mem_abc123.md`. Files
