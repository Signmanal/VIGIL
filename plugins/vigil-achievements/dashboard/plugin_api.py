...
Mounted at /api/plugins/vigil-achievements/ by VIGIL dashboard.
"""
...
try:
    ...
    import os as _os
    def get_vigil_home() -> Path:  # type: ignore[misc]
...
def state_path() -> Path:
    return get_vigil_home() / "plugins" / "vigil-achievements" / "state.json"


def snapshot_path() -> Path:
    return get_vigil_home() / "plugins" / "vigil-achievements" / "scan_snapshot.json"


def checkpoint_path() -> Path:
    return get_vigil_home() / "plugins" / "vigil-achievements" / "scan_checkpoint.json"
