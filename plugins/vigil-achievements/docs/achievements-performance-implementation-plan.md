...
- Snapshot persisted at `~/.vigil/plugins/vigil-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.vigil/plugins/vigil-achievements/scan_checkpoint.json`.
