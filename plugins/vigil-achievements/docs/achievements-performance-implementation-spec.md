...
- persisted runtime files:
  - `~/.vigil/plugins/vigil-achievements/state.json` (existing unlock state)
  - `~/.vigil/plugins/vigil-achievements/scan_snapshot.json` (new)
  - `~/.vigil/plugins/vigil-achievements/scan_checkpoint.json` (new)
