...
1. Bundled providers: ``plugins/cron_providers/<name>/`` (shipped with vigil-agent)
...
_USER_NAMESPACE = "_vigil_user_cron"


def _register_synthetic_package(name: str, search_locations: List[str]) -> None:
    """Register an empty package shell in sys.modules.

    User-installed providers import as ``_vigil_user_cron.<name>``, a dotted
    ...
    ``ModuleNotFoundError: No module named '_vigil_user_cron'`` — the same
