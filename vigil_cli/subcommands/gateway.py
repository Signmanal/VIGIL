...
from vigil_cli.subcommands._shared import add_accept_hooks_flag
...
def build_gateway_parser(
    ...
    gateway_migrate_legacy = gateway_subparsers.add_parser(
        "migrate-legacy",
        help="Remove legacy vigil.service units from pre-rename installs",
        description=(
            "Stop, disable, and remove legacy VIGIL gateway unit files "
            "(e.g. vigil.service) left over from older installs. Profile "
            "units (vigil-gateway-<profile>.service) and unrelated "
    ...
    gateway_enroll = gateway_subparsers.add_parser(
        ...
        description=(
            ...
            "Authenticates as your VIGIL Portal account (the connector derives the "
    ...
    proxy_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "to an OAuth-authenticated provider (e.g. VIGIL Portal). External "
