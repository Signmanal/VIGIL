...
TIPS = [
    ...
    "vigil chat --max-turns 200 overrides the default 90-iteration limit per turn.",
    ...
    'vigil import restores a session export or profile archive produced by sessions export or profile export.',
