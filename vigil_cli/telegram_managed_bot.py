...
DEFAULT_API_URL = "https://setup.vigil-agent.nousresearch.com"
...
DEFAULT_MANAGER_BOT = "VIGILSetupBot"
...
def generate_username_slug(length: int = 16) -> str:
    ...
    keeping ``vigil_<slug>_bot`` under Telegram's 32-character username limit.
    """
...
def generate_bot_username(profile_name: Optional[str] = None) -> str:
    """Generate a secure suggested bot username like ``vigil_<slug>_bot``.
    ...
    """
    _ = profile_name
    return f"vigil_{generate_username_slug()}_bot"
