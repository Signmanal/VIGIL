...
USER_OWNED_EXCLUDE: frozenset = frozenset({
    ...
    "backups", "cache",
    # Infrastructure
    "vigil-agent", ".worktrees", "profiles", "bin", "node_modules",
...
class DistributionManifest:
    ...
    def from_dict(cls, data: Any) -> "DistributionManifest":
        ...
        return cls(
            ...
            description=str(data.get("description") or ""),
            vigil_requires=str(data.get("vigil_requires") or ""),
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if self.vigil_requires:
            out["vigil_requires"] = self.vigil_requires
        if self.author:
...
def check_vigil_requires(spec: str, current_version: str) -> None:
...
def plan_install(
    ...
    check_vigil_requires(manifest.vigil_requires, vigil_version)
...
def install_distribution(
    ...
    with tempfile.TemporaryDirectory(prefix="vigil_dist_install_") as tmp:
...
def update_distribution(
    ...
    with tempfile.TemporaryDirectory(prefix="vigil_dist_update_") as tmp:
        plan = plan_install(
