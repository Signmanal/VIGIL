...
def _inherited_flag(parser, *args, **kwargs):
    """Register a flag that ``vigil_cli.relaunch`` should carry over when
...
Examples:
    ...
    vigil dashboard               Start web UI dashboard (port 9779)
...
def build_top_level_parser():
    ...
    parser = argparse.ArgumentParser(
        prog="vigil",
        description="VIGIL Agent - AI security operations assistant with controlled tool execution",
    ...
    chat_parser = subparsers.add_parser(
        ...
        description="Start an interactive chat session with VIGIL Agent",
    )
