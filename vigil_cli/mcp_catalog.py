...
Catalog policy:
- Entries are added only by merging a PR into vigil-agent. Presence in the
...
from vigil_constants import get_vigil_home, get_optional_mcps_dir
...
from vigil_cli.cli_output import prompt as _prompt_input
...
def _install_root() -> Path:
    ...
    root = get_vigil_home() / "mcp-installs"
