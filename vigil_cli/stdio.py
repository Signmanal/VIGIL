...
Entry points (``cli.py`` ``main``, ``vigil_cli/main.py`` CLI dispatch,
...
def _augment_path_with_known_tools() -> None:
    ...
    *spawned* processes only — already-running shells (including the one the
    ...
    candidate_dirs = [
        ...
        # VIGIL venv Scripts directory — host of the vigil.exe shim itself,
        ...
        os.path.join(local_appdata, "vigil", "vigil-agent", "venv", "Scripts"),
