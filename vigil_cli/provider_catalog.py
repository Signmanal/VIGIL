...
they were not: the CLI picker read :data:`vigil_cli.models.CANONICAL_PROVIDERS`
...
* ``auth_type`` / ``api_key_env_vars`` / ``base_url_env_var`` from
  :data:`vigil_cli.auth.PROVIDER_REGISTRY` (credential truth), and
...
# vigil_cli.auth.PROVIDER_REGISTRY and providers.base.ProviderProfile.
