...
(``docs/vigil-kanban-v1-spec.pdf``).  All DB work is delegated to
...
from vigil_cli import kanban_swarm as ks
...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    kanban_parser = parent_subparsers.add_parser(
        ...
        description=(
            ...
            "See https://vigil-agent.nousresearch.com/docs/user-guide/features/kanban "
            "or docs/vigil-kanban-v1-spec.pdf for the full design."
        ),
    )
    # --- global --board flag ---
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from vigil_cli import kanban_specify as spec
...
def _cmd_decompose(args: argparse.Namespace) -> int:
    ...
    from vigil_cli import kanban_decompose as decomp
